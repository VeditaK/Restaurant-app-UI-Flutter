...
class BannerWidgetArea extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    for(int x=0;x<bannerItems.length;x++){
      var bannerView=Padding(padding:EdgeInsets.all(10),
          child:Container(
            child: Stack(
              fit: StackFit.expand,
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text("More than 30% OFF,Grab ur meal.",style: TextStyle(fontSize: 12.0,color: Colors.white),),
